...
namespace vr
{
CallbackReturn VrSystem::on_init(const hardware_interface::HardwareInfo & info)
{
...
std::vector<hardware_interface::StateInterface> VrSystem::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> VrSystem::export_command_interfaces()
{
...
return_type VrSystem::read(const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
...
return_type VrSystem::write(const rclcpp::Time &, const rclcpp::Duration &)
{
...
PLUGINLIB_EXPORT_CLASS(
  vr::VrSystem, hardware_interface::SystemInterface)
